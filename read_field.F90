  ...
  ! ==========================================================================
   ...
   IF (ints == 0) THEN
     ...
     IF (loopYears) THEN
       ...
       !fieldFile = TRIM(physDataDir)//TRIM(physPrefixForm)//TRIM(dataprefix)//TRIM(tGridName)//TRIM(fileSuffix)
       fieldFile = TRIM(physDataDir)//TRIM( filledFileName(TRIM(physPrefixForm), endYear, 12, 30) )&
                 & //TRIM(tGridName)//TRIM(fileSuffix)
       IF (log_level >= 2) PRINT*,"read_field: ",fieldFile
     ...
     fieldFile = TRIM(physDataDir)//TRIM( filledFileName(TRIM(physPrefixForm), dateYear, dateMon, dateDay) )&
               & //TRIM(tGridName)//TRIM(fileSuffix)
     !fieldFile = TRIM(physDataDir)//TRIM(physPrefixForm)//TRIM(dataprefix)//TRIM(tGridName)//TRIM(fileSuffix)
     IF (log_level >= 2) PRINT*,"read_field: ", fieldFile
   ...
   IF (ints<intrun-1 .OR. loopYears) THEN
     ...
     fieldFile = TRIM(physDataDir)//TRIM( filledFileName(TRIM(physPrefixForm), dateYear, dateMon, dateDay) )&
               & //TRIM(tGridName)//TRIM(fileSuffix)
     IF (log_level >= 2) PRINT*,"read_field: ",fieldFile,TRIM(tGridName),TRIM(fileSuffix)
   ...
   fieldFile = TRIM(physDataDir)//TRIM( filledFileName(TRIM(physPrefixForm), dateYear, dateMon, dateDay) )&
             & //TRIM(uGridName)//TRIM(fileSuffix)
   ...
   fieldFile = TRIM(physDataDir)//TRIM( filledFileName(TRIM(physPrefixForm), dateYear, dateMon, dateDay) )&
             & //TRIM(vGridName)//TRIM(fileSuffix)
   IF (log_level >= 2) PRINT*,"read_field: ",fieldFile
